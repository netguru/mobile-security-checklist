...
| SD.15 | Medium | URLs passed outside of app (for example from API) | Validate url according whitelist of urls within app | [Handbook](../Handbooks/SD.15-URLs-passed-outside-of-app.md) |
